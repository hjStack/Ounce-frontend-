        ...
        <section className="mx-auto w-full max-w-7xl px-4 pb-14 md:px-8 md:pb-20 lg:px-12">
          ...
          >
            <div className="flex items-center gap-4">
              ...
              <div>
                <p className="text-sm font-bold text-white">
                  미드나이트 세일 — 매일 밤 10시부터 한 시간
                </p>
                <p className="mt-0.5 text-xs text-indigo-300">
                  선착순 한정 수량 · 내일 아침 7시 배송
                </p>
              </div>
            </div>
          ...
          <div className="mx-auto w-full max-w-7xl px-4 md:px-8 lg:px-12">
            <div className="mb-8 flex flex-col gap-4 md:mb-10 md:flex-row md:items-end md:justify-between">
              <div>
                ...
                <h2 className="text-2xl font-bold text-foreground-950 md:text-3xl">
                  오늘은 뭐 먹지?
                </h2>
              </div>
              <p className="max-w-xs text-sm text-foreground-500">
                찌개부터 파스타까지, 먹고 싶은 걸로 골라보세요
              </p>
            </div>
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="absolute inset-x-0 bottom-0 p-4">
                          <i
                            className={`${category.icon} mb-1 block text-lg text-accent-400`}
                          />
...
function Stat({
  ...
  return (
    <div
      className={
        divided ? "sm:border-l sm:border-background-200 sm:pl-7 md:pl-9" : ""
      }
    >
...
function FeatureCard({
  ...
  return (
    <div className="flex items-start gap-4 rounded-xl border border-background-200 bg-white p-5 shadow-sm transition-shadow hover:shadow-md">
      ...
      <div>
        <h3 className="mb-0.5 text-sm font-bold text-foreground-950">
          {title}
        </h3>
